...
public class ModifyUserDialog extends JDialog {
    ...
    public ModifyUserDialog(JTable usersTable, UserService userService) {
        ...
        acceptButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    boolean newUserState = ModifyUserDialog.this.stateComboBox.getSelectedItem().toString() == "Activo" ? true : false;
					...
					ModifyUserDialog.this.errorMessageLabel.setText("Se detectaron datos no válidos.");
				}
            }
        });
    }
